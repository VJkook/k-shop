...
const Sidebar: React.FC = () => {
    ...
    <aside className={styles.sidebar}>
        ...
        <nav>
            ...
            <a href="/admin" className={styles.nav_link}><span>Заказы</span></a>

            <a href="/confectioners" className={styles.nav_link}><span>Кондитеры</span></a>
            <a href="/products/create" className={`${styles.nav_link} ${styles.nav_link_active}`}><span>Создать товар</span></a>
